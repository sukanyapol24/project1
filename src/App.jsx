...
body{font-family:var(--ff);background:var(--off);color:var(--dark);overflow-x:hidden;line-height:1.6;font-size:15px}
img{display:block}
...
.nav{position:sticky;top:0;z-index:900;background:rgba(255,255,255,.97);backdrop-filter:blur(16px);border-bottom:1.5px solid var(--border);padding:0 2.5rem}
.nav-inner{max-width:1400px;margin:0 auto;display:flex;align-items:center;height:66px;gap:1.8rem}
.nav-logo{font-family:var(--ffd);font-size:1.65rem;font-weight:700;color:var(--dark);cursor:pointer;flex-shrink:0}
...
.prod-card{background:var(--white);border:1px solid var(--border);border-radius:var(--rl);overflow:hidden;cursor:pointer;transition:all .3s var(--ease);box-shadow:var(--sh)}
...
.blog-card{background:var(--white);border:1px solid var(--border);border-radius:var(--rl);overflow:hidden;cursor:pointer;transition:all .3s;box-shadow:var(--sh)}
...
.adopt-card{background:var(--white);border:1px solid var(--border);border-radius:var(--rl);overflow:hidden;transition:all .3s;box-shadow:var(--sh)}
...
.adopt-mi{background:var(--g4);border-radius:8px;padding:.4rem .7rem}
...
.groom-card{background:var(--white);border:1.5px solid var(--border);border-radius:var(--rl);padding:1.8rem;transition:all .3s;position:relative;overflow:hidden;box-shadow:var(--sh)}
...
.rev-sum{background:var(--g4);border-radius:var(--rxl);padding:2.2rem;border:1px solid var(--border);margin-bottom:1.5rem}
...
.rev-form{background:var(--white);border:1px solid var(--border);border-radius:var(--rl);padding:1.8rem;box-shadow:var(--sh);margin-bottom:1.5rem}
...
.finp,.fsel,.ftxt{width:100%;padding:.65rem .85rem;background:var(--g5);border:1.5px solid var(--border);border-radius:8px;color:var(--dark);font-family:var(--ff);font-size:.86rem;outline:none;transition:border-color .2s}
...
.rev-card{background:var(--white);border:1px solid var(--border);border-radius:var(--r);padding:1.2rem;box-shadow:var(--sh)}
...
.cform{background:var(--white);border:1px solid var(--border);border-radius:var(--rl);padding:2rem;box-shadow:var(--sh)}
...
.det-rc{background:var(--g4);border-radius:10px;padding:.9rem 1.1rem;border:1px solid var(--border);margin-bottom:.55rem}
...
.cart-pan{position:fixed;top:0;right:0;width:400px;height:100vh;background:var(--white);border-left:1px solid var(--border);z-index:1001;display:flex;flex-direction:column;box-shadow:-8px 0 48px rgba(26,43,22,.18)}
.cp-hd{display:flex;align-items:center;justify-content:space-between;padding:1.3rem 1.6rem;border-bottom:1px solid var(--border)}
...
.cp-item{display:flex;gap:.85rem;align-items:center;padding:.85rem 0;border-bottom:1px solid var(--border)}
.cp-item img{width:60px;height:60px;border-radius:10px;object-fit:cover;border:1px solid var(--border);flex-shrink:0}
...
.cp-ft{padding:1.4rem 1.6rem;border-top:1px solid var(--border)}
...
.toast{position:fixed;bottom:2rem;left:50%;transform:translateX(-50%);background:var(--dark);color:#fff;padding:.72rem 1.8rem;border-radius:8px;font-size:.8rem;font-weight:800;z-index:9999;box-shadow:0 4px 24px rgba(0,0,0,.2);white-space:nowrap;letter-spacing:.02em}

.footer{background:var(--dark);padding:3rem 2.5rem 1.8rem}
...
export default function App(){
  ...
  return(
    <><style>{CSS}</style><AnnBar/><Nav page={page} setPage={setPage} cartCount={cart.length} openCart={()=>setCartOpen(true)}/><main key={page}>{render()}</main><Footer setPage={setPage}/><Toast msg={toastMsg}/>{cartOpen&&<CartPanel cart={cart} onClose={()=>setCartOpen(false)} onRemove={removeFromCart} toast={toast}/>}</>
  );
}
